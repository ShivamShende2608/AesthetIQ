  ...
  return (
    <div
      ...
      className={`relative backdrop-blur-lg border rounded-3xl p-8 transition-all duration-700 cursor-pointer ${
        featured
          ? "bg-gradient-to-b from-[dodgerblue]/20 to-[#00ffff]/20 border-blue-400/50 scale-105"
    ...
    >
      {featured && (
        <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
          <div className="bg-gradient-to-r from-[dodgerblue] to-[#008B8B] text-white px-6 py-2 rounded-full text-sm font-bold
">
            Most Popular
          </div>
        </div>
      ...
      <div className="text-center">
        ...
        <div className="text-4xl font-bold bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent mb-6
">
          ₹{price}
        ...
        <Button
          variant={featured ? "dodgerToDarkAqua" : "glass"}
          size="xl"
          className="w-full"
          onClick={handlePopup}
...
const PricingSection = () => {
  const plans = [
    ...
    },
    {
      ...
      featured: true,
      planId: "cplan_30dj4dVQvlPyJMZiX2ZLcvRrgXq",
      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-white mb-6">
            Simple{" "}
            <span className="bg-gradient-to-r from-[dodgerblue] to-cyan-300 bg-clip-text text-transparent
">
              Pricing
            </span>
          </h2>
