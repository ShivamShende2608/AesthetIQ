    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      <div className="text-center z-10 px-6">
        ...
        >
          ...
          <span className="bg-gradient-to-r from-blue-500 via-green-400 to-cyan-500 bg-clip-text text-transparent animate-pulse">
         ...
         <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
            Next-gen image editing with AI precision. Crop, refine, balance colors, clear backgrounds, and upgrade visuals using future-ready tools.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
            <Link href="/dashboard">
              <Button variant="dodgerToDarkAqua" size="xl">
                Start Creating
              </Button>
            </Link>
          ...
          <div className="backdrop-blur-lg bg-white/10 border border-white/20 rounded-3xl p-6 transform-gpu">
            <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl p-8 min-h-96">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-gray-400 text-sm">AesthetIQ Pro</div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-4 mb-6">
               ...
               <div className="flex items-center justify-center">
                <div className="w-full h-48 bg-gradient-to-r from-blue-500 via-green-400 to-cyan-500 rounded-2xl shadow-2xl shadow-blue-500/50 flex items-center justify-center">
      ...
      <section className="py-20 text-center">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-5xl font-bold mb-6">
            Ready to{" "}
            <span className="bg-gradient-to-r from-[dodgerblue] to-[#00FFF7] bg-clip-text text-transparent
">
